...
import { governorateLabel, conditionLabel } from '@/lib/constants/enums';
 ...
 */
export function AdBrowseCard({ ad, onView, onEdit, onTakedown, onRestore, onDelete, busy }: AdBrowseCardProps) {
